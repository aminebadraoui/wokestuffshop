...
class CollectionListViewModel: CollectionListOutputs, CollectionListInputs, CollectionListType {
    
    let client = Client.shared
    let disposeBag = DisposeBag()
    
    var collectionList = [CollectionCompatible]()
    ...
    func fetchCollections() {
        ...
        .subscribe(onNext: { collectionModelList in
            ...
            self.collectionList = collectionModelList.map { collectionModel -> CollectionCardItemViewModel in
            ...
            self.dataSource.collectionData = self.collectionList
